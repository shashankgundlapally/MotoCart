...
<!--  <div class="text-left" >
  ...
  <a class="navbar-brand" style="font-size:27px;margin-top: -4px;">
     <i class="fa fa-opencart" aria-hidden="true"></i>MotoCart </a>
  ...
  <img src="D:\workspace\MotoCart\src\main\webapp\resources\images\1.jpg" class="img-rounded" alt="tq" width="304" height="236"> 
  </div>
