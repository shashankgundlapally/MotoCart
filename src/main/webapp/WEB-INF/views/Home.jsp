...
<body>
	...
	<div>
		<center>
			<h2 style="color: white;font-style: italic;" align="right"> Moto Cart </h2>
			<h3 style="color: white; font-family: cursive;"align="right">Deals  like  never before </h3>
